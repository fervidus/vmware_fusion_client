...
module VMWareFusionClient
  class VMPowerState
    ...
    def valid?
      ...
      power_state_validator = EnumAttributeValidator.new('String', ['poweredOn', 'poweredOff', 'paused', 'suspended'])
    ...
    def power_state=(power_state)
      validator = EnumAttributeValidator.new('String', ['poweredOn', 'poweredOff', 'paused', 'suspended'])
