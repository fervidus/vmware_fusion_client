...
# Unit tests for VMWareFusionClient::Network
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Network' do
  before do
    # run before each test
    @instance = VMWareFusionClient::Network.new
  end
  ...
  describe 'test an instance of Network' do
    it 'should create an instance of Network' do
      expect(@instance).to be_instance_of(VMWareFusionClient::Network)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["bridged", "nat", "hostOnly"])
  ...
  describe 'test attribute "dhcp"' do
    it 'should work' do
      ...
      # validator.allowable_values.each do |value|
      #   expect { @instance.dhcp = value }.not_to raise_error
      # end
    end
  end
